...
from inseeds.models import farmer_management.model as M # noqa
...
model_path = "./lpjml/LPJmL_internal"
inseeds_config_file = "./inseeds/inseeds/models/farmer_management/config.yaml"  # noqa"
